...
class UtilAjaxYui extends UtilAjax implements IUtilAjax
{
    ...
    {
        if (self::$IsGoogleApi){
            return self::loadJsSentence("https://ajax.googleapis.com/ajax/libs/yui/$version/build/yui/yui-min.js");
        }else{
            return self::loadJsSentence("core/js/yui.js");
        }
    }
    ...
    public static function ajaxRequstStatement($url,$dataArray,$method,$response_type=EnumResponseType::XML,$callback=null)
    {
        ...
        if (!empty($callback)){
            ...
            $result.=self::loadJsSentence($url_base."core/js/xmltojson.js");     
        }
